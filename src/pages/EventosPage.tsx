            ...
            eventosFiltrados.map((e) => (
              <Card key={e.id} className="h-full overflow-hidden flex flex-col">
                ...
                <div className="p-4 flex-1 flex flex-col gap-2">
                  ...
                  <h3 className="gap-4 pb-2 text-base font-extrabold">
                    {e.titulo}
                  </h3>
                  <div className="flex flex-wrap gap-4">
                    <Tag variant="primary">data: {e.data || "—"}</Tag>
                    <Tag variant="primary">Horário: {e.hora || "—"}</Tag>
                    <Tag variant="primary">local: {e.local || "—"}</Tag>
                  </div>
                  <Button
                    variant="secondary"
                    fullWidth
