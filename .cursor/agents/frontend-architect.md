...
- SEO crítico
- necessidade de tag manager e mensuração
...
- revisar estrutura por domínios
- orientar performance, indexação, acessibilidade e mensuração
- sugerir melhorias sem quebrar a simplicidade operacional
...
- usar o BFF para adaptar payloads à necessidade da tela
- não propor abstrações prematuras
- preservar clareza de contratos e composição de componentes
...
4. avaliação da estratégia atual de renderização
5. recomendação arquitetural
6. estrutura sugerida
7. impactos no BFF
8. testes, acessibilidade e observabilidade
9. próximos passos